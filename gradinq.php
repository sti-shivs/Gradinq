...
define('KBGV_WPUSERS', true ); // set to TRUE if all your students have a WP login at your blog AND their profile emails match the email column in your spreadsheet.
...
function kbgv_plugin_init(){
	...
	function kbgv_admin_menu(){
		add_menu_page(__('Gradebook', 'kbgb'), __('Gradebook', 'kbgb'), 'delete_others_posts', 'kb-gradebook.php', 'kbgv_admin_page');
	}
